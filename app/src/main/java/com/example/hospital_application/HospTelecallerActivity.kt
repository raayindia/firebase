...
class HospTelecallerActivity : AppCompatActivity() , HomeFragment.BottomSheetStateListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hosp_telecaller)
        fragmentContainer = findViewById(R.id.telenav_host_fragment)
        menuIcon = findViewById(R.id.telecustomHamburgerIcon)
        notificon = findViewById(R.id.telenotificon)
        drawerLayout = findViewById(R.id.teledrawerLayout)
        offerbtn = findViewById(R.id.teleoffer)
        timertext = findViewById(R.id.timer)
        subsbtn= findViewById(R.id.telesubsbtn2)
        textlist= findViewById(R.id.teletext)
        navparent = findViewById(R.id.telenavhost_parent)

        TimeCheckSubscription()
        val nav_menu = findViewById<NavigationView>(R.id.telenavView)
...
//                R.id.Logout -> fragment = BlankFragment3()
            ...
            if (fragment != null) {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.teleframe_welcome, fragment)
                    .commit()
        ...
        navController = Navigation.findNavController(this, R.id.telenav_host_fragment)
        bottomNavigationView= findViewById(R.id.telebottom_navigation)
    ...
    override fun onBackPressed() {
        ...
        builder.setMessage("Are you sure you want to exit?")
            ...
            .setPositiveButton("Ok") { dialog, id ->
                ...
                val intent = Intent(this@HospTelecallerActivity, LoginActivity::class.java)
                startActivity(intent)
                finish();
            }
            .setNegativeButton(
