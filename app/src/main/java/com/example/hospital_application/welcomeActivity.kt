...
class welcomeActivity : AppCompatActivity(), HomeFragment.BottomSheetStateListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menuIcon = findViewById(R.id.customHamburgerIcon)
        notificon = findViewById(R.id.notificon)
        drawerLayout = findViewById(R.id.drawerLayout)
        offerbtn = findViewById(R.id.offer)
        timertext = findViewById(R.id.timer)
        subsbtn= findViewById(R.id.subsbtn2)
        textlist= findViewById(R.id.text)
        navparent = findViewById(R.id.navhost_parent)
//        frameLayout = findViewById(R.id.frame_welcome)
TimeCheckSubscription()
        val nav_menu = findViewById<NavigationView>(R.id.navView)
...
//                R.id.Logout -> fragment = BlankFragment3()
            ...
            if (fragment != null) {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.frame_welcome, fragment)
                    .commit()
