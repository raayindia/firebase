...
class HospSuperAdminActivity : AppCompatActivity(), HomeFragment.BottomSheetStateListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hosp_super_admin)

        fragmentContainer = findViewById(R.id.supernav_host_fragment)
        menuIcon = findViewById(R.id.supercustomHamburgerIcon)
        notificon = findViewById(R.id.supernotificon)
        drawerLayout = findViewById(R.id.superdrawerLayout)
        offerbtn = findViewById(R.id.superoffer)
        timertext = findViewById(R.id.supertimer)
        subsbtn= findViewById(R.id.supersubsbtn2)
        textlist= findViewById(R.id.supertext)
        navparent = findViewById(R.id.supernavhost_parent)

        TimeCheckSubscription()
        val nav_menu = findViewById<NavigationView>(R.id.supernavView)
...
//                R.id.Logout -> fragment = BlankFragment3()
            ...
            if (fragment != null) {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.superframe, fragment)
                    .commit()
        ...
        navController = Navigation.findNavController(this, R.id.supernav_host_fragment)
        bottomNavigationView= findViewById(R.id.superbottom_navigation)
...
//                    setToolbarColor(R.color.blue)
        ...
        toggle.syncState()
//        val totalDurationInMillis = TimeUnit.DAYS.toMillis(3) + TimeUnit.HOURS.toMillis(24)
//
...
//                timertext.text = "Countdown finished!"
//            }
//        }
//
    ...
    override fun onBackPressed() {
        ...
        builder.setMessage("Are you sure you want to exit?")
            ...
            .setPositiveButton("Ok") { dialog, id ->
                ...
                val intent = Intent(this@HospSuperAdminActivity, LoginActivity::class.java)
                startActivity(intent)
                finish();
            }
            .setNegativeButton(
